...
import com.team1160.logomotion.autonomous.AutonomousFileManager;
...
public class Team1160 extends IterativeRobot {
    ...
    protected AutonomousFileManager autonomousFileManager;
    ...
    protected void initAutoFileManager(){
        try{
            this.autonomousFileManager = AutonomousFileManager.getInstance();
        }catch(Exception e){
...
//            System.out.println("Done reading: " + this.autonomousFileManager.doneReading());
            if(!this.autonomousFileManager.doneReading()){
                if(this.autonomousFileManager != null){
                    nextRobotCommand = this.autonomousFileManager.read();
